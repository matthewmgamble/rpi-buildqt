...
echo
cloneOrPull https://github.com/qt/qtbase.git ${RPIDEV_SRC}/qtbase 5.9

echo
echo == Download qtdeclarative ==
echo
cloneOrPull https://github.com/qt/qtdeclarative.git ${RPIDEV_SRC}/qtdeclarative 5.9

echo
echo == Download qtquickcontrols ==
echo
cloneOrPull https://github.com/qt/qtquickcontrols.git ${RPIDEV_SRC}/qtquickcontrols 5.9

echo
echo == Download qtquickcontrols2 ==
echo
cloneOrPull https://github.com/qt/qtquickcontrols2.git ${RPIDEV_SRC}/qtquickcontrols2 5.9
